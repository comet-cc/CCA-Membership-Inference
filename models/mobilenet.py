...
https://github.com/jmjeon2/MobileNet-Pytorch/tree/master'''
...
def mobilenet(pretrained=False, **kwargs):
    ...
    if pretrained:
        print("pretrined is selected but nothing to do")
    return model

def create_model(arch, pretrained=False, **kwargs):
    return eval(arch)(pretrained=pretrained, ch_in=3, **kwargs)
